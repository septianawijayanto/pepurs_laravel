            ...
            <table class="table table-responsiv mytable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$dt->jml_buku}}</td>
                        <td>
                            <a href="{{url('admin/buku/edit/'.$dt->id)}}" class="btn btn-success btn-xs btn-flat"><i class="lnr lnr-pencil"></i></a>
                            <a href="{{url('admin/buku/delete/'.$dt->id)}}" class="btn btn-danger btn-xs btn-flat" onclick="return confirm ('Apakah Akan Anda Hapus?')"><i class="lnr lnr-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
