...
<body>
    <table class="center">
        ...
        <tr>
            <td style="border: 0px;">
                <b style="font-size: 30px;">SMP Negeri 9 Tebo</b>
            </td>
        </tr>
        <tr>
            <td style="border: 0px;">NPSN :10503278</td>
            <td style="border: 0px;">
                <font style="font-size: 20px;">Jalan Kenanga, Suka Damai, Rimbo Ulu, Kab. Tebo Kode Pos : 37553</font>
            </td>
